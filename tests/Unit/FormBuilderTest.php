...
class FormBuilderTest extends UnitTestCase
{
    ...
    public function testLabelBladeDirective()
    {
        ...
        $expectedHtml = '<label for="field-name" class="col-sm-3 control-label">Label Text</label>';
    ...
    public function testTextBladeDirective()
    {
        ...
        $expectedHtml = "<div class=\"form-group\">\n\n            <label for=\"input-field\" class=\"col-sm-3 control-label\">Text field label</label>    \n<input class=\"form-control blue\" placeholder=\"Placeholder\" name=\"input-field\" type=\"text\" value=\"test text\">\n\n\n\n\n    </div>\n";
    ...
    public function testTelBladeDirective()
    {
        ...
        $expectedHtml = "<div class=\"form-group\">\n\n            <label for=\"input-field\" class=\"col-sm-3 control-label\">Text field label</label>    \n<input class=\"form-control blue\" placeholder=\"Placeholder\" name=\"input-field\" type=\"tel\" value=\"test text\">\n\n\n\n\n    </div>\n";
    ...
    public function testMonthBladeDirective()
    {
        ...
        $expectedHtml = "<div class=\"form-group\">\n\n            <label for=\"input-field\" class=\"col-sm-3 control-label\">Text field label</label>    \n<input class=\"form-control blue\" placeholder=\"Placeholder\" name=\"input-field\" type=\"month\" value=\"test text\">\n\n\n\n\n    </div>\n";
    ...
    public function testWeekBladeDirective()
    {
        ...
        $expectedHtml = "<div class=\"form-group\">\n\n            <label for=\"input-field\" class=\"col-sm-3 control-label\">Text field label</label>    \n<input class=\"form-control blue\" placeholder=\"Placeholder\" name=\"input-field\" type=\"week\" value=\"3\">\n\n\n\n\n    </div>\n";
    ...
    public function testSearchBladeDirective()
    {
        ...
        $expectedHtml = "<div class=\"form-group\">\n\n            <label for=\"input-field\" class=\"col-sm-3 control-label\">Text field label</label>    \n<input class=\"form-control blue\" placeholder=\"Placeholder\" name=\"input-field\" type=\"search\" value=\"3\">\n\n\n\n\n    </div>\n";
    ...
    public function testRangeBladeDirective()
    {
        ...
        $expectedHtml = "<div class=\"form-group\">\n\n            <label for=\"input-field\" class=\"col-sm-3 control-label\">Text field label</label>    \n<input class=\"form-control blue\" placeholder=\"Placeholder\" name=\"input-field\" type=\"range\" value=\"3\">\n\n\n\n\n    </div>\n";
    ...
    public function testNumberBladeDirective()
    {
        ...
        $expectedHtml = "<div class=\"form-group\">\n\n            <label for=\"input-field\" class=\"col-sm-3 control-label\">Text field label</label>    \n<input class=\"form-control blue\" placeholder=\"Placeholder\" name=\"input-field\" type=\"number\" value=\"5\">\n\n\n\n\n    </div>\n";
    ...
    public function testColorBladeDirective()
    {
        ...
        $expectedHtml = "<div class=\"form-group\">\n\n            <label for=\"input-field\" class=\"col-sm-3 control-label\">Text field label</label>    \n<input class=\"form-control blue\" placeholder=\"Placeholder\" name=\"input-field\" type=\"color\" value=\"#ff0000\">\n\n\n\n\n    </div>\n";
    ...
    public function testEmailBladeDirective()
    {
        ...
        $expectedHtml = "<div class=\"form-group\">\n\n            <label for=\"input-field\" class=\"col-sm-3 control-label\">Text field label</label>    \n<input class=\"form-control blue\" placeholder=\"Placeholder\" name=\"input-field\" type=\"email\" value=\"test text\">\n\n\n\n\n    </div>\n";
    ...
    public function testPasswordBladeDirective()
    {
        ...
        $expectedHtml = "<div class=\"form-group\">\n\n            <label for=\"input-field\" class=\"col-sm-3 control-label\">Text field label</label>    \n<input class=\"form-control blue\" placeholder=\"Placeholder\" name=\"input-field\" type=\"password\" value=\"\">\n\n\n\n\n    </div>\n";
    ...
    public function testUrlBladeDirective()
    {
        ...
        $expectedHtml = "<div class=\"form-group\">\n\n            <label for=\"input-field\" class=\"col-sm-3 control-label\">Text field label</label>    \n<input class=\"form-control blue\" placeholder=\"Placeholder\" name=\"input-field\" type=\"url\" value=\"test url\">\n\n\n\n\n    </div>\n";
    ...
    public function testFileBladeDirective()
    {
        ...
        $expectedHtml = "<div class=\"form-group\">\n\n            <label for=\"input-field\" class=\"col-sm-3 control-label\">Text field label</label>    \n<input class=\"form-control form-control-file blue\" placeholder=\"Placeholder\" name=\"input-field\" type=\"file\">\n\n\n\n\n    </div>\n";
    ...
    public function testTextareaBladeDirective()
    {
        ...
        $expectedHtml = "<div class=\"form-group\">\n\n            <label for=\"input-field\" class=\"col-sm-3 control-label\">Text field label</label>    \n<textarea class=\"form-control blue\" placeholder=\"Placeholder\" name=\"input-field\" cols=\"50\" rows=\"10\">example text</textarea>\n\n\n\n\n    </div>\n";
    ...
    public function testSelectBladeDirective()
    {
        ...
        $expectedHtml = "<div class=\"form-group\">\n\n            <label for=\"input-field\" class=\"col-sm-3 control-label\">Text field label</label>    \n<select class=\"form-control blue\" name=\"input-field\"><option value=\"\">Placeholder</option><option value=\"0\">test1</option><option value=\"1\">test2</option><option value=\"2\">test3</option></select>\n\n\n\n\n    </div>\n";
    ...
    public function testSelectMonthsBladeDirective()
    {
        ...
        $expectedHtml = "<div class=\"form-group\">\n\n            <label for=\"input-field\" class=\"col-sm-3 control-label\">Text field label</label>    \n<select class=\"form-control blue\" name=\"input-field\"><option value=\"\">Placeholder</option><option value=\"1\">January</option><option value=\"2\">February</option><option value=\"3\" selected=\"selected\">March</option><option value=\"4\">April</option><option value=\"5\">May</option><option value=\"6\">June</option><option value=\"7\">July</option><option value=\"8\">August</option><option value=\"9\">September</option><option value=\"10\">October</option><option value=\"11\">November</option><option value=\"12\">December</option></select>\n\n\n\n\n    </div>\n";
    ...
    public function testSelectWeekdaysBladeDirective()
    {
        ...
        $expectedHtml = "<div class=\"form-group\">\n\n            <label for=\"input-field\" class=\"col-sm-3 control-label\">Text field label</label>    \n<select class=\"form-control blue\" name=\"input-field\"><option value=\"\">Placeholder</option><option value=\"1\">Sunday</option><option value=\"2\">Monday</option><option value=\"3\" selected=\"selected\">Tuesday</option><option value=\"4\">Wednesday</option><option value=\"5\">Thursday</option><option value=\"6\">Friday</option><option value=\"7\">Saturday</option></select>\n\n\n\n\n    </div>\n";
    ...
    public function testSelectRangeWithIntervalBladeDirective()
    {
        ...
        $expectedHtml = "<div class=\"form-group\">\n\n            <label for=\"input-field\" class=\"col-sm-3 control-label\">Text field label</label>    \n<select class=\"form-control blue\" name=\"input-field\"><option value=\"\">Placeholder</option><option value=\"1\">1</option><option value=\"3\" selected=\"selected\">3</option><option value=\"5\">5</option></select>\n\n\n\n\n    </div>\n";
    ...
    public function testDatetimeBladeDirective()
    {
        ...
        $expectedHtml = "<div class=\"form-group\">\n\n            <label for=\"input-field\" class=\"col-sm-3 control-label\">Text field label</label>    \n<div class=\"input-group date\" id=\"datetimepicker-input-field\" data-target-input=\"nearest\">\n    <input class=\"form-control datetimepicker-input blue\" placeholder=\"Placeholder\" autocomplete=\"noway\" data-target=\"#datetimepicker-input-field\" name=\"input-field\" type=\"datetime\">\n    <span class=\"input-group-addon\" data-target=\"#datetimepicker-input-field\" data-toggle=\"datetimepicker\">\n        <i class=\"fa fa-btn fa-calendar\"></i>\n    </span>\n</div>\n\n\n\n\n\n    </div>\n";
    ...
    public function testStaticTextBladeDirective()
    {
        ...
        $expectedHtml = "<div class=\"form-group\">\n\n            <label for=\"\" class=\"col-sm-3 control-label\">Text field label</label>    \n<p class=\"form-control-static\">input-field</p>\n\n\n    </div>\n";
