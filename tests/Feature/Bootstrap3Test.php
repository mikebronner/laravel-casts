...
class Bootstrap3Test extends FeatureTestCase
{
    ...
    public function testNumberInputWithLabel()
    {
        $this->visit('/genealabs/laravel-casts/examples/bootstrap3')
            ...
            ->seeInElement(
                'label[for=number1][class="col-sm-3 control-label"]',
                'Number Input'
            )
            ->seeStatusCode('200');
    }
    ...
    public function testSelectMonths()
    {
        $this->visit('/genealabs/laravel-casts/examples/bootstrap3')
            ...
            ->seeInElement(
                'label[for=selectMonths1][class="col-sm-3 control-label"]',
                'Select'
            )
            ->seeStatusCode('200');
    }
    ...
    public function testSelectWeekdays()
    {
        $this->visit('/genealabs/laravel-casts/examples/bootstrap3')
            ...
            ->seeInElement(
                'label[for=selectWeekdays1][class="col-sm-3 control-label"]',
                'Select'
            )
            ->seeStatusCode('200');
    }
