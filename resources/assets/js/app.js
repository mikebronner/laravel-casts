...
if ((window.genealabsLaravelCasts.dateTimeLoaders || false) !== false) {
  ...
  if (window.genealabsLaravelCasts.framework === "bootstrap3") {
    ...
    $.getScript(
      "/genealabs-laravel-casts/bootstrap3-datetimepicker.js",
      function() {
        window.genealabsLaravelCasts.dateTimeLoaders.forEach(function(
          dateTimeLoader
        ) {
          dateTimeLoader();
        });
  ...
  if (window.genealabsLaravelCasts.framework === "bootstrap4") {
    ...
    $.getScript(
      "/genealabs-laravel-casts/bootstrap4-datetimepicker.js",
      function() {
        window.genealabsLaravelCasts.dateTimeLoaders.forEach(function(
          dateTimeLoader
        ) {
...
if ((window.genealabsLaravelCasts.signatureLoaders || false) !== false) {
  ...
  $.getScript("/genealabs-laravel-casts/signature-pad.js", function() {
    window.genealabsLaravelCasts.signatureLoaders.forEach(function(
      signatureLoader
    ) {
      signatureLoader();
    });
...
if ((window.genealabsLaravelCasts.comboboxLoaders || false) !== false) {
  ...
  $.getScript("/genealabs-laravel-casts/bootstrap-combobox.js", function() {
    window.genealabsLaravelCasts.comboboxLoaders.forEach(function(
      comboboxLoader
    ) {
      comboboxLoader();
    });
