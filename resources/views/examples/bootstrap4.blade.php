        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                @form(['url' => 'genealabs/laravel-casts/examples/bootstrap4', 'class' => 'form-horizontal'])
                    ...
                    @date('date1')
                    @datetime('datetime1')
                    @combobox('combobox1', [1, 2, 3, 4], null, ['placeholder' => 'Placeholder Text', 'label' => 'Combobox'])
            ...
            <div class="col-sm-6">
                ...
                @form(['url' => 'genealabs/laravel-casts/examples/bootstrap4'])
                    ...
                    @date('date2')
                    @datetime('datetime2')
                    @combobox('combobox2', [1, 2, 3, 4], null, ['placeholder' => 'Placeholder Text', 'label' => 'Combobox'])
