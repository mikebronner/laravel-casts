    ...
    <div class="container mx-auto flex flex-wrap">
        <div class="w-1/2 px-4">
            ...
            @form(['url' => 'genealabs/laravel-casts/examples/tailwind', 'class' => 'form-horizontal', 'framework' => 'tailwind'])
                ...
                @selectRange ('select_range1', 1, 21, null, ['placeholder' => 'Placeholder Text', 'label' => 'Select Range'])
                @selectRangeWithInterval ('select_range_with_interval1', 1, 21, 3, null, ['placeholder' => 'Placeholder Text', 'label' => 'Select Range With Interval'])
                @button ('button1')
                {{-- @date ('date1')
                @datetime ('datetime1')
        ...
        <div class="w-1/2">
            ...
            @form (['url' => 'genealabs/laravel-casts/examples/tailwind'])
                ...
                @selectRange('selectRange2', 1, 21, null, ['placeholder' => 'Placeholder Text', 'label' => 'Select Range'])
                @selectRangeWithInterval('selectRangeWithInterval2', 1, 21, 3, null, ['placeholder' => 'Placeholder Text', 'label' => 'Select Range With Interval'])
