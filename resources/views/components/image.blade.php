...
>
    ...
    <div
        ...
        x-data="imageUploader('{{ $name }}', '{{ $value }}')"
    >
        <input
            class="w-full h-full p-0 m-0 text-center bg-contain border-0 cursor-pointer"
            type="text"
        ...
        >
        <p
            class="absolute bottom-0 flex items-center justify-between w-full px-3 py-1 overflow-hidden text-white bg-gray-400"
    ...
    <script defer>
        document.addEventListener("alpine:init", function () {
            return Alpine.data("imageUploader", function (name, uri) {
                return {
                    fieldName: name,
                    fileUri: uri,
                    imagePreviewData: uri,
