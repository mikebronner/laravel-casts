...
>
    ...
    >
        ...
        >
            ...
            ></canvas>
            <div
                class="absolute bottom-0 left-0 right-0 p-4 pt-1 text-center border-t border-gray-400 border-dashed footer"
            >
                ...
                @if ($label)
                    <x-form-label
                        :field="$name"
                        :value="$label"
                        class="{{ $labelClasses }} text-sm italic"
                    />
                @endif
                ...
                <button
                    type="button"
                    class="px-2 py-0 ml-4 text-sm text-gray-600 transition duration-300 ease-in-out bg-transparent border border-gray-600 rounded cursor-pointer hover:bg-gray-600 hover:text-gray-100"
    ...
    <script>
        ...
        var canvas = document.querySelector(".signature." + name + " canvas");
            console.log("test1", window.SignaturePad, canvas);
        ...
        if ((window.SignaturePad !== undefined) && (canvas !== null)) {
            ...
            if (window.setImageData === undefined) {
                window.setImageData = function (name) {
                    ...
                    document.querySelector("input[type=hidden][name=" + name + "]").value = imageData;
                    document.querySelector("input[type=hidden][name=" + name + "_date]").value = timestamp;
                };
            }
            ...
            if (window.clearSignature === undefined) {
                window.clearSignature = function (name) {
                    ...
                    document.querySelector("input[type=hidden][name=" + name + "_date]").value = "";
                };
            }
            ...
            window.resizeCanvas(name);
            window["signaturePad" + name].fromDataURL(document.querySelector("input[type=hidden][name=" + name + "]").value);
        }
    </script>
</x-form-group>
