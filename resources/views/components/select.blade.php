        ...
        >
                <div x-on:click="open" class="w-full">
                    <div class="relative flex items-center">
                        ...
                        >
                            <div
                                class="flex items-center m-1 mr-2 px-1 font-medium text-blue-800 bg-blue-100 rounded"
                            >
                                <div
                        ...
                        <input
                            class="flex-shrink max-w-full min-w-12 italic font-light text-gray-400"
